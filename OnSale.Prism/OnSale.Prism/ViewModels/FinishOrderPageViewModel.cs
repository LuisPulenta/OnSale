...
namespace OnSale.Prism.ViewModels
{
    public class FinishOrderPageViewModel : ViewModelBase
    {
        ...
        private async void FinishOrderAsync()
        {
            ...
            Response response = await _apiService.PostAsync(url, "api", "/Orders", request, token.Token);
            IsRunning = false;
            IsEnabled = true;
            ...
            await App.Current.MainPage.DisplayAlert("Ok", "La Orden fue grabada con éxito!", "Accept");
        ...
        private async Task<bool> ValidateDataAsync()
        {
            ...
            {
                await App.Current.MainPage.DisplayAlert("Error", "PaymentMethodError", "Accept");
                return false;
            }

            if (string.IsNullOrEmpty(DeliveryAddress))
            {
                await App.Current.MainPage.DisplayAlert("Error", "DeliveryAddressError", "Accept");
                return false;
            }
